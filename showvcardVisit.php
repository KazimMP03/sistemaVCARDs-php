...
<body>
    ...
    <div class="fundo">
        <a href="sistVisit.php?page=consultavcardsVisit.php" class="retbtn" title="Voltar"><i class='bx bxs-chevrons-left'></i></a>
        <?php
        include_once('config.php');
        ...
        ?>
            ...
            <div class="containerbuttons">
                <a href="sistVisit.php?page=favoritarvcardVisit.php?id=<?php echo $id_vcard; ?>" class="favvcard" title="Favoritar/Desfavoritar"><i class='bx bx-star'></i></a>
                <a href="sistVisit.php?page=likevcardVisit.php?id=<?php echo $id_vcard; ?>" class="favvcard" title="Like/Dislike"><i class='bx bx-heart'></i></a>
