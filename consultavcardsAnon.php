                ...
                <table class="table-cons">
                    ...
                    <tbody>
                        ...
                        while ($user_data = mysqli_fetch_assoc($result)) {
                            ...
                            echo "<td>
                            <a class='actbtn' href='sistAnon.php?page=showvcardAnon.php?id=$user_data[id]' title='Visualizar'>
    ...
    <script>
        ...
        function searchData() {
            ...
            if (selectedColumn === 'data_vcard') {
                ...
                $('#content-placeholder').load('consultavcardsAnon.php?search=' + formattedDate + '&column=' + selectedColumn);
            } else {
                $('#content-placeholder').load('consultavcardsAnon.php?search=' + searchTerm + '&column=' + selectedColumn);
            }
        }
