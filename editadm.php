...
<body>
    <div class="fundo">
        <a href="sistAdm.php?page=consultausuarios.php" class="retbtn" title="Voltar"><i class='bx bxs-chevrons-left'></i></a>
        <div class="tablesuser">

            <form id="editForm" action="saveEditUserAdm.php" method="POST">
