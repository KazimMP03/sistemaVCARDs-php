                    ...
                    <table class="table-cons">
                        ...
                        <tbody>
                            ...
                            while ($user_data = mysqli_fetch_assoc($result)) {
                                ...
                                echo "<td>
                            <a class='actbtn' href='sistAnon.php?page=showvcardEvAnon.php?id=$id_showvcard' title='Visualizar'>
        ...
        <script>
            ...
            function searchData() {
                ...
                if (selectedColumn === 'data_evento') {
                    ...
                    $('#content-placeholder').load('consultaeventosAnon.php?search=' + formattedDate + '&column=' + selectedColumn);
                } else {
                    $('#content-placeholder').load('consultaeventosAnon.php?search=' + searchTerm + '&column=' + selectedColumn);
                }
            }
