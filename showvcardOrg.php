    ...
    <div class="fundo">
        ...
        ?>
            ...
            <div class="containerbuttons">
                <a href="sistOrg.php?page=favoritarvcardOrg.php?id=<?php echo $id_vcard; ?>" class="favvcard" title="Favoritar/Desfavoritar"><i class='bx bx-star'></i></a>
                <a href="sistOrg.php?page=likevcardOrg.php?id=<?php echo $id_vcard; ?>" class="favvcard" title="Like/Dislike"><i class='bx bx-heart'></i></a>
