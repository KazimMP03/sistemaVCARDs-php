...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_FILES['arquivo']) && isset($_POST['id_vcard'])) {
  ...
  if ($deu_certo) {
    ...
    if ($result) {
      ...
      echo "<script>alert('Foto atualizada com sucesso!'); window.location.href='sistAdm.php?page=editvcard.php?id=$id_vcard';</script>";
      exit;
    } else {
...
<head>
  ...
  <title>EasyVCARDS - Administrador</title>
</head>
...
<body>
    ...
    <div class="menu-bar">
      <div class="menu">
        <ul class="menu-links">
          ...
          <li class="nav-link">
            <a href="#" data-page="perfilAdm.php">
          ...
          <li class="nav-link">
            <a href="#" data-page="consultausuarios.php">
          ...
          <li class="nav-link">
            <a href="#" data-page="consultaeventos.php">
          ...
          <li class="nav-link">
            <a href="#" data-page="consultavcards.php">
          ...
          <li class="nav-link">
            <a href="#" data-page="favoritos.php">
  ...
  <section class="home" id="home-section">
    ...
    <div class="navbar">
      ...
      <div class="navbar-content">
        <button class="logout-button" onmouseover="changeBackgroundColor(this, true)" onmouseout="changeBackgroundColor(this, false)" onclick="window.location.href='sistAdm.php?page=perfilAdm.php'" title="Perfil">
          <i class='bx bx-user-circle'></i>
        </button>
        <button class="logout-button" onmouseover="changeBackgroundColor(this, true)" onmouseout="changeBackgroundColor(this, false)" onclick="window.location.href='sistAdm.php?page=consultausuarios.php'" title="Usuários">
          <i class='bx bx-user-check'></i>
        </button>
        <button class="logout-button" onmouseover="changeBackgroundColor(this, true)" onmouseout="changeBackgroundColor(this, false)" onclick="window.location.href='sistAdm.php?page=consultaeventos.php'" title="Eventos">
          <i class='bx bx-store-alt'></i>
        </button>
        <button class="logout-button" onmouseover="changeBackgroundColor(this, true)" onmouseout="changeBackgroundColor(this, false)" onclick="window.location.href='sistAdm.php?page=consultavcards.php'" title="Vcards">
          <i class='bx bx-news'></i>
        </button>
        <button class="logout-button" onmouseover="changeBackgroundColor(this, true)" onmouseout="changeBackgroundColor(this, false)" onclick="window.location.href='sistAdm.php?page=favoritos.php'" title="Favoritos">
        ...
        <button class="logout-button2" onmouseover="changeBackgroundColor(this, true)" onmouseout="changeBackgroundColor(this, false)" onclick="toggleDropdown()">
          ...
          <div class="dropdown" id="dropdown-menu">
            <a href="sistAdm.php?page=perfilAdm.php" title="Perfil"><i class='bx bx-user-circle' title="Perfil"></i></a>
            <a href="sistAdm.php?page=consultausuarios.php" title="Usuários"><i class='bx bx-user-check' title="Usuários"></i></a>
            <a href="sistAdm.php?page=consultaeventos.php" title="Eventos"><i class='bx bx-store-alt' title="Eventos"></i></a>
            <a href="sistAdm.php?page=consultavcards.php" title="Vcards"><i class='bx bx-news' title="Vcards"></i></a>
            <a href="sistAdm.php?page=favoritos.php" title="Favoritos"><i class='bx bx-star' title="Favoritos"></i></a>
