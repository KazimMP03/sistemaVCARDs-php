...
if (isset($_POST['submit'])) {
    ...
    echo "<script>alert('Vcard Editado Com Sucesso!'); window.location.href='sistPart.php?page=consultavcardsPart.php';</script>";
}
echo "<script>alert('ERRO CARAIO!'); window.location.href='sistPart.php?page=perfilPart.php';</script>";
