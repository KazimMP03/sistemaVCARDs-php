...
<body>
    ...
    <div class="fundo2">
        <div class="tablesuser2">
            <div>
                <div class="search-container">
                    ...
                    <a class='addmembbtn' href="#" onclick="addEvent()" title="Adicionar Evento">
                    ...
                    <table class="table-cons">
                        ...
                        <tbody>
                            ...
                            while ($user_data = mysqli_fetch_assoc($result)) {
                                ...
                                $idCriador = $user_data['id_criador'];
                                if ($idCriador == $id) {
                                    echo "<td>
            <a class='actbtn' href='sistOrg.php?page=editeventOrg.php?id_evento=$user_data[id_evento]' title='Editar'>
                <i class='bx bx-edit'></i>
            </a> 
            <a class='actbtn' href='deleteeventOrg.php?id_evento=$user_data[id_evento]' title='Deletar'>
                <i class='bx bx-trash'></i>
            </a>
            </a>
            <a class='actbtn' href='sistOrg.php?page=showvcardEvOrg.php?id=$id_showvcard' title='Visualizar'>
        ...
        <a class='actbtn' href='sistOrg.php?page=showvcardEvOrg.php?id=$id_showvcard' title='Visualizar'>
        <i class='bx bx-show'></i>
    </a></td>"; // Não mostra nada se o criador não for o usuário logado
                                }
                                echo "</tr>";
                            }
                            ?>
        ...
        <script>
            ...
            function searchData() {
                ...
                if (selectedColumn === 'data_evento') {
                    ...
                    $('#content-placeholder').load('consultaeventosOrg.php?search=' + formattedDate + '&column=' + selectedColumn);
                } else {
                    $('#content-placeholder').load('consultaeventosOrg.php?search=' + searchTerm + '&column=' + selectedColumn);
                }
            }
            ...
            function addEvent() {
                $('#content-placeholder').load('sistOrg.php?page=cadastroeventoOrg.php');
            }
        </script>
