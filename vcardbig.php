...
<body>
    ...
    <div class="fundo">
        <a href="sistAdm.php?page=favoritos.php" class="retbtn" title="Voltar"><i class='bx bxs-chevrons-left'></i></a>
        <?php
        include_once('config.php');
        ...
        ?>
            ...
            <div class="containerbuttons">
                <a href="sistAdm.php?page=favoritarvcardfav.php?id=<?php echo $id_vcard; ?>" class="favvcard" title="Favoritar/Desfavoritar"><i class='bx bx-star'></i></a>
                <a href="sistAdm.php?page=likevcardfav.php?id=<?php echo $id_vcard; ?>" class="favvcard" title="Like/Dislike"><i class='bx bx-heart'></i></a>
