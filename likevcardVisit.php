...
if (isset($_GET['id'])) {
    ...
    if ($verificar_result->num_rows > 0) {
        ...
        echo "<script>alert('Você descurtiu este Vcard!'); window.location.href='sistVisit.php?page=showvcardVisit.php?id=$id_vcard';</script>";
        exit;
    } else {
        ...
        echo "<script>alert('Você curtiu este Vcard!'); window.location.href='sistVisit.php?page=showvcardVisit.php?id=$id_vcard';</script>";
        exit;
    }
} else {
