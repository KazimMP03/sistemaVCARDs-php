...
if (isset($_GET['id'])) {
    ...
    if ($consulta_result->num_rows > 0) {
        ...
        if ($verificar_result->num_rows > 0) {
            ...
            echo "<script>alert('Este Vcard foi desfavoritado da sua lista!'); window.location.href='sistVisit.php?page=showvcardEvVisit.php?id=$id_vcard';</script>";
            exit;
        } else {
            ...
            echo "<script>alert('Este Vcard foi adicionado à sua lista de favoritos!'); window.location.href='sistVisit.php?page=favoritosVisit.php';</script>";
            exit;
        }
    } else {
