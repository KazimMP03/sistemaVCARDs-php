...
<body>
    <div class="fundo">
        ...
        <div class="editbtnfoto">
            <form enctype="multipart/form-data" action="sistOrg.php?page=editvcardOrg.php?id=<?php echo $id; ?>" method="POST" id="uploadForm">
        ...
        <a href="sistOrg.php?page=consultavcardsOrg.php" class="retbtn" title="Voltar"><i class='bx bxs-chevrons-left'></i></a>
        <div class="tablesuser">

            <form id="editForm" action="saveEditVcardOrg.php" method="POST">
