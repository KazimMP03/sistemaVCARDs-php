...
if (!empty($_GET['search'])) {
    ...
    $sql = "SELECT * FROM usuarios WHERE $column LIKE '%$data%' ORDER BY id DESC";
} else {
...
<body>
                ...
                <table class="table-cons">
                    ...
                    <tbody>
                        ...
                        while ($user_data = mysqli_fetch_assoc($result)) {
                            ...
                            echo "<td>
                            <a class='actbtn' href='sistAdm.php?page=editadm.php?id=$user_data[id]' title='Editar'>
    ...
    <script>
        ...
        function searchData() {
            ...
            $('#content-placeholder').load('consultausuarios.php?search=' + searchTerm + '&column=' + selectedColumn);
        }

        function addMember() {
            $('#content-placeholder').load('sistAdm.php?page=cadastroadm.php');
        }
    </script>
