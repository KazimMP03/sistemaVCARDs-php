...
$id_vcard = isset($_GET['id_vcard']) ? $_GET['id_vcard'] : null;
...
<body>
    ...
    <div class="fundo">
        <a href="sistVisit.php?page=favoritosVisit.php" class="retbtn" title="Voltar"><i class='bx bxs-chevrons-left'></i></a>
        <?php
        include_once('config.php');
        ...
        ?>
            ...
            <div class="containerbigs" style="user-select: none;">
                        ...
                        <div class="flip-card-frontbig">
                            <div class="whitebgbig">
                                <div class="titulovcardbig">
                                    <p><?php echo $vcard_data['titulo']; ?></p>
                                </div>
                            </div>
            ...
            <div class="containerbuttons">
                <a href="sistVisit.php?page=favoritarvcardfavVisit.php?id=<?php echo $id_vcard; ?>" class="favvcard" title="Favoritar/Desfavoritar"><i class='bx bx-star'></i></a>
                <a href="sistVisit.php?page=likevcardfavVisit.php?id=<?php echo $id_vcard; ?>" class="favvcard" title="Like/Dislike"><i class='bx bx-heart'></i></a>
    ...
    <script>
        ...
        var perfilText = "VCARD FAVORITADO";
