    ...
    <div class="fundo">
        ...
        ?>
            ...
            <div class="containerbuttons">
                <a href="sistPart.php?page=favoritarvcardPart.php?id=<?php echo $id_vcard; ?>" class="favvcard" title="Favoritar/Desfavoritar"><i class='bx bx-star'></i></a>
                <a href="sistPart.php?page=likevcardPart.php?id=<?php echo $id_vcard; ?>" class="favvcard" title="Like/Dislike"><i class='bx bx-heart'></i></a>
