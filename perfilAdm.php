    ...
    <div class="fundo">
        ...
        <div class="tablesuser">
            <table class="info-table">
                ...
                <tr>
                    <td>
                        <form enctype="multipart/form-data" action="sistAdm.php?page=perfilAdm.php" method="POST" id="uploadForm">
        ...
        <div>
            <a href="sistAdm.php?page=editperfil.php?id=<?php echo $id; ?>" class="editbtn" title="Editar Perfil"><i class='bx bx-edit'></i></a>
        </div>
