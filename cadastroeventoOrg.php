...
if (isset($_POST['submit'])) {
    ...
    echo "<script>alert('Evento Criado Com Sucesso! Favor criar o VCARD do Evento!'); window.location.href='sistOrg.php?page=editvcardevOrg.php?id=$idvcard';</script>";
}
...
<body>
    <div class="fundo">
        ...
        <div class="tablesuser">
            ...
            <form id="editForm" action="cadastroeventoOrg.php" method="POST">
