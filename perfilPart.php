    ...
    <div class="fundo">
        ...
        <div class="tablesuser">
            <table class="info-table">
                ...
                <tr>
                    <td>
                        <form enctype="multipart/form-data" action="sistPart.php?page=perfilPart.php" method="POST" id="uploadForm">
        ...
        <div>
            <a href="sistPart.php?page=editperfil.php?id=<?php echo $id; ?>" class="editbtn" title="Editar Perfil"><i class='bx bx-edit'></i></a>
        </div>
