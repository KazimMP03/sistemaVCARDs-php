...
if (isset($_POST['submit'])) {
    ...
    echo "<script>alert('Vcard Criado Com Sucesso!'); window.location.href='sistOrg.php?page=consultaeventosOrg.php';</script>";
}
echo "<script>alert('ERRO!'); window.location.href='sistAdm.php?page=perfilAdm.php';</script>";
