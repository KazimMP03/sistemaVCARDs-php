...
if (!empty($_GET['id'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        $resultDelete = $conexao->query($sqlDelete);
        echo "<script>alert('Vcard Deletado Com Sucesso!'); window.location.href='sistPart.php?page=consultavcardsPart.php';</script>";
        exit;
    }
}

// Redireciona para sistAdm.php com a indicação para carregar consulta.php
header('Location: sistPart.php?page=consultavcardsPart.php');
