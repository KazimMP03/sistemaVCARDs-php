                    ...
                    <table class="table-cons">
                        ...
                        <tbody>
                            ...
                            while ($user_data = mysqli_fetch_assoc($result)) {
                                ...
                                echo "<td>
                            <a class='actbtn' href='sistAdm.php?page=editevent.php?id_evento=$user_data[id_evento]' title='Editar'>
                            <i class='bx bx-edit'></i>
                                </a> 
                                <a class='actbtn' href='deleteevent.php?id_evento=$user_data[id_evento]' title='Deletar'>
                                <i class='bx bx-trash'></i>
                            </a>
                            <a class='actbtn' href='sistAdm.php?page=showvcardEv.php?id=$id_showvcard' title='Visualizar'>
        ...
        <script>
            ...
            function searchData() {
                ...
                if (selectedColumn === 'data_evento') {
                    ...
                    $('#content-placeholder').load('consultaeventos.php?search=' + formattedDate + '&column=' + selectedColumn);
                } else {
                    $('#content-placeholder').load('consultaeventos.php?search=' + searchTerm + '&column=' + selectedColumn);
                }
            }
            ...
            function addEvent() {
                $('#content-placeholder').load('sistAdm.php?page=cadastroevento.php');
            }
        </script>
