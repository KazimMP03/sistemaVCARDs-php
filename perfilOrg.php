    ...
    <div class="fundo">
        ...
        <div class="tablesuser">
            <table class="info-table">
                ...
                <tr>
                    <td>
                        <form enctype="multipart/form-data" action="sistOrg.php?page=perfilOrg.php" method="POST" id="uploadForm">
        ...
        <div>
            <a href="sistOrg.php?page=editperfil.php?id=<?php echo $id; ?>" class="editbtn" title="Editar Perfil"><i class='bx bx-edit'></i></a>
        </div>
