...
<body>
    <div class="fundo">
        ...
        <div class="editbtnfoto">
            <form enctype="multipart/form-data" action="sistPart.php?page=editvcardPart.php?id=<?php echo $id; ?>" method="POST" id="uploadForm">
                <input type="file" name="arquivo" id="foto" accept="image/*" style="display: none;">
                <a href="#" class="editbtn" id="editFotoLink" title="Editar Foto"><i class='bx bxs-camera-plus'></i></a>
                <input type="submit" value="Enviar" style="display: none;">
                <input type='hidden' name='id_vcard' value='<?php echo $id; ?>'>
            </form>
        </div>

        <a href="sistPart.php?page=consultavcardsPart.php" class="retbtn" title="Voltar"><i class='bx bxs-chevrons-left'></i></a>
        <div class="tablesuser">

            <form id="editForm" action="saveEditVcardPart.php" method="POST">
                <table class='user-table'>
                    ...
                    <tr>
                        ...
                        <td class='value2'>
                            ...
                            <a class="whts" href="javascript:void(0);" onclick="copyToClipboard('<?php echo $chave; ?>')">
                                <i class="bx bx-copy-alt"></i>
                            </a>
                            <a class="whtss" href="https://api.whatsapp.com/send?text=Aqui está a chave-convite para evento (<?php echo $titulo ?>): <?php echo $chave ?>">
    ...
    <tr>
        ...
        <td class='value4'>
            <label for='apresentacao' class='apresentacao-label'><?php echo $apresentacao ?></label>
    ...
    <tr>
        ...
        <td class='value8'>
            <label for='categoria' class='categoria-label'><?php echo $categoria ?></label>
    ...
    <tr>
        ...
        <td class='value9'>
            <label for='redes' class='redes-label'><?php echo $redes ?></label>
    ...
    <tr>
        ...
        <td class='value10'>
            <label for='contato' class='contato-label'><?php echo $contato ?></label>
    ...
    <tr>
        ...
        <td class='value11'>
            <label for='patrocinadores' class='patrocinadores-label'><?php echo $patrocinadores ?></label>
