...
<body>
    ...
    <script>
        ...
        function redirectVcardBig(id_vcard) {
            window.location.href = 'sistOrg.php?page=vcardbigOrg.php?id_vcard=' + id_vcard;
        }

        document.getElementById('ordenarPorTitulo').addEventListener('click', function() {
            window.location.href = 'sistOrg.php?page=favoritosOrg.php?ordena=titulo';
        });

        document.getElementById('ordenarPorData').addEventListener('click', function() {
            window.location.href = 'sistOrg.php?page=favoritosOrg.php?ordena=data';
        });
        ...
        document.getElementById('searchForm').addEventListener('submit', function(event) {
            ...
            window.location.href = 'sistOrg.php?page=favoritosOrg.php?buscafav=' + encodeURIComponent(buscafav);
        });
    </script>
