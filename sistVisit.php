...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_FILES['arquivo']) && isset($_POST['id_vcard'])) {
    ...
    if ($arquivo['error']) {
        echo "<script>alert('Erro ao carregar a foto!'); window.location.href='sistVisit.php?page=perfilVisit.php';</script>";
        exit;
    }
    if ($arquivo['size'] > 2100000) {
        echo "<script>alert('A foto deve ter no máximo 2mb de tamanho!'); window.location.href='sistVisit.php?page=perfilVisit.php';</script>";
        exit;
    }
    ...
    if ($extensao != "jpg" && $extensao != 'png') {
        echo "<script>alert('O arquivo da foto deve possuir a extensãp .png ou .jpg!'); window.location.href='sistVisit.php?page=perfilVisit.php';</script>";
        exit;
    }
    ...
    if ($deu_certo) {
        ...
        if ($result) {
            ...
            echo "<script>alert('Foto atualizada com sucesso!'); window.location.href='sistVisit.php?page=editvcard.php?id=$id_vcard';</script>";
            exit;
        } else {
            echo "<script>alert('Erro ao carregar a foto! Tente novamente mais tarde.'); window.location.href='sistVisit.php?page=perfilVisit.php';</script>";
        }
    } else {
        echo "<script>alert('Erro ao carregar a foto! Tente novamente mais tarde.'); window.location.href='sistVisit.php?page=perfilVisit.php';</script>";
    }
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_FILES['foto'])) {
    ...
    if ($largura !== $altura) {
        echo "<script>alert('A imagem deve ser um quadrado perfeito largura = altura!'); window.location.href='sistVisit.php?page=perfilVisit.php';</script>";
        exit;
    }
    $pasta = "fotos/";
    $nomeDoArquivo = $arquivo['name'];
    ...
    if ($deu_certo) {
        ...
        if ($result) {
            $_SESSION['foto'] = $path;
            echo "<script>alert('Foto atualizada com sucesso!'); window.location.href='sistVisit.php?page=perfilVisit.php';</script>";
            exit;
        } else {
            echo "<script>alert('Erro ao carregar a foto! Tente novamente mais tarde.'); window.location.href='sistVisit.php?page=perfilVisit.php';</script>";
        }
...
<head>
    ...
    <title>EasyVCARDS - Visitante</title>
</head>
...
<body>
        ...
        <div class="menu-bar">
            <div class="menu">
                <ul class="menu-links">
                    ...
                    <li class="nav-link">
                        <a href="#" data-page="perfilVisit.php">
                    ...
                    <li class="nav-link">
                        <a href="#" data-page="consultaeventosVisit.php">
                    ...
                    <li class="nav-link">
                        <a href="#" data-page="consultavcardsVisit.php">
                    ...
                    <li class="nav-link">
                        <a href="#" data-page="favoritosVisit.php">
    ...
    <section class="home" id="home-section">
        ...
        <div class="navbar">
            ...
            <div class="navbar-content">
                <button class="logout-button" onmouseover="changeBackgroundColor(this, true)" onmouseout="changeBackgroundColor(this, false)" onclick="window.location.href='sistVisit.php?page=perfilVisit.php'" title="Perfil">
                    <i class='bx bx-user-circle'></i>
                </button>
                <button class="logout-button" onmouseover="changeBackgroundColor(this, true)" onmouseout="changeBackgroundColor(this, false)" onclick="window.location.href='sistVisit.php?page=consultaeventosVisit.php'" title="Eventos">
                    <i class='bx bx-store-alt'></i>
                </button>
                <button class="logout-button" onmouseover="changeBackgroundColor(this, true)" onmouseout="changeBackgroundColor(this, false)" onclick="window.location.href='sistVisit.php?page=consultavcardsVisit.php'" title="Vcards">
                    <i class='bx bx-news'></i>
                </button>
                <button class="logout-button" onmouseover="changeBackgroundColor(this, true)" onmouseout="changeBackgroundColor(this, false)" onclick="window.location.href='sistVisit.php?page=favoritosVisit.php'" title="Favoritos">
                ...
                <button class="logout-button2" onmouseover="changeBackgroundColor(this, true)" onmouseout="changeBackgroundColor(this, false)" onclick="toggleDropdown()">
                    ...
                    <div class="dropdown" id="dropdown-menu">
                        <a href="sistVisit.php?page=perfilVisit.php" title="Perfil"><i class='bx bx-user-circle' title="Perfil"></i></a>
                        <a href="sistVisit.php?page=consultaeventosVisit.php" title="Eventos"><i class='bx bx-store-alt' title="Eventos"></i></a>
                        <a href="sistVisit.php?page=consultavcardsVisit.php" title="Vcards"><i class='bx bx-news' title="Vcards"></i></a>
                        <a href="sistVisit.php?page=favoritosVisit.php" title="Favoritos"><i class='bx bx-star' title="Favoritos"></i></a>
