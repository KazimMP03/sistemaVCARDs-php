                ...
                <table class="table-cons">
                    ...
                    <tbody>
                        ...
                        while ($user_data = mysqli_fetch_assoc($result)) {
                            ...
                            $id_proprietario = $user_data['id_proprietario'];
                            if ($id_proprietario == $id) {
                                echo "<td>
                            <a class='actbtn' href='sistPart.php?page=editvcardPart.php?id=$user_data[id]' title='Editar'>
                            <i class='bx bx-edit'></i>
                                </a> 
                                <a class='actbtn' href='deletevcardPart.php?id=$user_data[id]' title='Deletar'>
                                <i class='bx bx-trash'></i>
                            </a>
                            <a class='actbtn' href='sistPart.php?page=showvcardPart.php?id=$user_data[id]' title='Visualizar'>
    ...
    <script>
        ...
        function searchData() {
            ...
            if (selectedColumn === 'data_vcard') {
                ...
                $('#content-placeholder').load('consultavcardsPart.php?search=' + formattedDate + '&column=' + selectedColumn);
            } else {
                $('#content-placeholder').load('consultavcardsPart.php?search=' + searchTerm + '&column=' + selectedColumn);
            }
        }
        ...
        function addVcard() {
            $('#content-placeholder').load('sistPart.php?page=cadastrovcardPart.php');
        }
    </script>
