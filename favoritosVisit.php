...
<body>
    ...
    <script>
        ...
        function redirectVcardBig(id_vcard) {
            window.location.href = 'sistVisit.php?page=vcardbigVisit.php?id_vcard=' + id_vcard;
        }

        document.getElementById('ordenarPorTitulo').addEventListener('click', function() {
            window.location.href = 'sistVisit.php?page=favoritosVisit.php?ordena=titulo';
        });

        document.getElementById('ordenarPorData').addEventListener('click', function() {
            window.location.href = 'sistVisit.php?page=favoritosVisit.php?ordena=data';
        });
        ...
        document.getElementById('searchForm').addEventListener('submit', function(event) {
            ...
            window.location.href = 'sistVisit.php?page=favoritosVisit.php?buscafav=' + encodeURIComponent(buscafav);
        });
    </script>
