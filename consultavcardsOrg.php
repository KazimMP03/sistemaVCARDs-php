                        ...
                        <tbody>
                            ...
                            while ($user_data = mysqli_fetch_assoc($result)) {
                                ...
                                if ($id_proprietario == $id) {
                                    echo "<td>
                                <a class='actbtn' href='sistOrg.php?page=editvcardOrg.php?id=$user_data[id]' title='Editar'>
                                <i class='bx bx-edit'></i>
                                    </a> 
                                    <a class='actbtn' href='deletevcardOrg.php?id=$user_data[id]' title='Deletar'>
                                    <i class='bx bx-trash'></i>
                                </a>
                                <a class='actbtn' href='sistOrg.php?page=showvcardOrg.php?id=$user_data[id]' title='Visualizar'>
        ...
        <script>
            ...
            function searchData() {
                ...
                if (selectedColumn === 'data_vcard') {
                    ...
                    $('#content-placeholder').load('consultavcardsOrg.php?search=' + formattedDate + '&column=' + selectedColumn);
                } else {
                    $('#content-placeholder').load('consultavcardsOrg.php?search=' + searchTerm + '&column=' + selectedColumn);
                }
            }
            ...
            function addVcard() {
                $('#content-placeholder').load('sistOrg.php?page=cadastrovcard.php');
            }
        </script>
