    ...
    <div class="fundo">
        ...
        ?>
            ...
            <div class="containerbuttons">
                <a href="sistAdm.php?page=favoritarvcard.php?id=<?php echo $id_vcard; ?>" class="favvcard" title="Favoritar/Desfavoritar"><i class='bx bx-star'></i></a>
                <a href="sistAdm.php?page=likevcard.php?id=<?php echo $id_vcard; ?>" class="favvcard" title="Like/Dislike"><i class='bx bx-heart'></i></a>
