...
<body>
    ...
    <div class="fundo">
        <a href="sistPart.php?page=consultaeventosPart.php" class="retbtn" title="Voltar"><i class='bx bxs-chevrons-left'></i></a>
        <?php
        include_once('config.php');
        ...
        ?>
            ...
            <div class="containerbuttons">
                <a href="sistPart.php?page=favoritarvcardevPart.php?id=<?php echo $id_vcard; ?>" class="favvcard" title="Favoritar/Desfavoritar"><i class='bx bx-star'></i></a>
                <a href="sistPart.php?page=likevcardevPart.php?id=<?php echo $id_vcard; ?>" class="favvcard" title="Like/Dislike"><i class='bx bx-heart'></i></a>
