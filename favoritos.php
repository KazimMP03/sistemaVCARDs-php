...
<body>
    ...
    <script>
        ...
        function redirectVcardBig(id_vcard) {
            window.location.href = 'sistAdm.php?page=vcardbig.php?id_vcard=' + id_vcard;
        }

        document.getElementById('ordenarPorTitulo').addEventListener('click', function() {
            window.location.href = 'sistAdm.php?page=favoritos.php?ordena=titulo';
        });

        document.getElementById('ordenarPorData').addEventListener('click', function() {
            window.location.href = 'sistAdm.php?page=favoritos.php?ordena=data';
        });
        ...
        document.getElementById('searchForm').addEventListener('submit', function(event) {
            ...
            window.location.href = 'sistAdm.php?page=favoritos.php?buscafav=' + encodeURIComponent(buscafav);
        });
    </script>
