...
<body>
    <div class="fundo">
        ...
        <div class="editbtnfoto">
            <form enctype="multipart/form-data" action="sistAdm.php?page=editvcard.php?id=<?php echo $id; ?>" method="POST" id="uploadForm">
        ...
        <div class="tablesuser">
            ...
            <form id="editForm" action="saveEditVcard.php" method="POST">
